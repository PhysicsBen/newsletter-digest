...
Reads the database URL from src.config.settings so that changing DATABASE_URL
in .env is the only step needed — no changes here.
"""
...
# Inject the database URL from pydantic-settings (reads .env)
